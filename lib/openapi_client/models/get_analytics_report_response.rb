...
module OpenapiClient
  class GetAnalyticsReportResponse
    ...
    # array of analytics objects for the videos returned
    attr_accessor :items

    attr_accessor :summary

    # number of views at the 1% point of the video duration for all videos
    attr_accessor :video_engagement_1

    # number of views at the 25% point of the video duration for all videos
    attr_accessor :video_engagement_25

    # number of views at the 50% point of the video duration for all videos
    attr_accessor :video_engagement_50

    # number of views at the 75% point of the video duration for all videos
    attr_accessor :video_engagement_75

    # number of views at the 100% point of the video duration for all videos
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GetAnalyticsReportResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GetAnalyticsReportResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @video_engagement_1.nil?
        invalid_properties.push('invalid value for "video_engagement_1", video_engagement_1 cannot be nil.')
      end

      if @video_engagement_25.nil?
        invalid_properties.push('invalid value for "video_engagement_25", video_engagement_25 cannot be nil.')
      end

      if @video_engagement_50.nil?
        invalid_properties.push('invalid value for "video_engagement_50", video_engagement_50 cannot be nil.')
      end

      if @video_engagement_75.nil?
        invalid_properties.push('invalid value for "video_engagement_75", video_engagement_75 cannot be nil.')
      end

      if @video_engagement_100.nil?
        invalid_properties.push('invalid value for "video_engagement_100", video_engagement_100 cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @video_engagement_1.nil?
      return false if @video_engagement_25.nil?
      return false if @video_engagement_50.nil?
      return false if @video_engagement_75.nil?
      return false if @video_engagement_100.nil?
      true
    end
    ...
    def hash
      [account, item_count, items, summary, video_engagement_1, video_engagement_25, video_engagement_50, video_engagement_75, video_engagement_100].hash
    end
