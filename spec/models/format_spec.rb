...
# Unit tests for OpenapiClient::Format
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Format do
  let(:instance) { OpenapiClient::Format.new }

  describe 'test an instance of Format' do
    it 'should create an instance of Format' do
      expect(instance).to be_instance_of(OpenapiClient::Format)
    end
  end
end
