...
# Unit tests for OpenapiClient::GetEventsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetEventsResponse do
  let(:instance) { OpenapiClient::GetEventsResponse.new }

  describe 'test an instance of GetEventsResponse' do
    it 'should create an instance of GetEventsResponse' do
      expect(instance).to be_instance_of(OpenapiClient::GetEventsResponse)
    end
  end
