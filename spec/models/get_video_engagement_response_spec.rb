...
# Unit tests for OpenapiClient::GetVideoEngagementResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetVideoEngagementResponse do
  let(:instance) { OpenapiClient::GetVideoEngagementResponse.new }

  describe 'test an instance of GetVideoEngagementResponse' do
    it 'should create an instance of GetVideoEngagementResponse' do
      expect(instance).to be_instance_of(OpenapiClient::GetVideoEngagementResponse)
    end
  end
