...
# Unit tests for OpenapiClient::GetEventsResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetEventsResponseData do
  let(:instance) { OpenapiClient::GetEventsResponseData.new }

  describe 'test an instance of GetEventsResponseData' do
    it 'should create an instance of GetEventsResponseData' do
      expect(instance).to be_instance_of(OpenapiClient::GetEventsResponseData)
    end
  end
