...
# Unit tests for OpenapiClient::LiveDimensions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LiveDimensions do
  let(:instance) { OpenapiClient::LiveDimensions.new }

  describe 'test an instance of LiveDimensions' do
    it 'should create an instance of LiveDimensions' do
      expect(instance).to be_instance_of(OpenapiClient::LiveDimensions)
    end
  end
end
