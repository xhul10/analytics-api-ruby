...
# Unit tests for OpenapiClient::Dimensions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Dimensions do
  let(:instance) { OpenapiClient::Dimensions.new }

  describe 'test an instance of Dimensions' do
    it 'should create an instance of Dimensions' do
      expect(instance).to be_instance_of(OpenapiClient::Dimensions)
    end
  end
end
