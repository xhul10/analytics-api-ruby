...
# Unit tests for OpenapiClient::LiveWhere
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LiveWhere do
  let(:instance) { OpenapiClient::LiveWhere.new }

  describe 'test an instance of LiveWhere' do
    it 'should create an instance of LiveWhere' do
      expect(instance).to be_instance_of(OpenapiClient::LiveWhere)
    end
  end
end
