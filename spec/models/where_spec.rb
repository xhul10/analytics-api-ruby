...
# Unit tests for OpenapiClient::Where
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Where do
  let(:instance) { OpenapiClient::Where.new }

  describe 'test an instance of Where' do
    it 'should create an instance of Where' do
      expect(instance).to be_instance_of(OpenapiClient::Where)
    end
  end
end
