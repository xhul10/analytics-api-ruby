...
# Unit tests for OpenapiClient::GetTimeSeriesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetTimeSeriesResponse do
  let(:instance) { OpenapiClient::GetTimeSeriesResponse.new }

  describe 'test an instance of GetTimeSeriesResponse' do
    it 'should create an instance of GetTimeSeriesResponse' do
      expect(instance).to be_instance_of(OpenapiClient::GetTimeSeriesResponse)
    end
  end
